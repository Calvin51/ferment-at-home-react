                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <ul className="navbar-nav ms-auto mb-2 mb-lg-0 text-center">
                                    <li className="nav-item me-5">
                                        <NavLink className="nav-link fw-bold" to="/products">商品列表</NavLink>
                                    </li>
                                    <li className="nav-item me-5">
                                        <NavLink className="nav-link fw-bold" to="/about">品牌故事</NavLink>
                                    </li>
                                    <li className="nav-item me-5">
                                        <NavLink className="nav-link fw-bold" to="/fqa">常見問題</NavLink>
                                    </li>
                                    <li className="nav-item me-5 d-block d-lg-none">
                                        <NavLink className="nav-link fw-bold text-primary" to="#">登入/註冊</NavLink>
                                    </li>
                                </ul>
            ...
            <footer className="container-fluid bg-primary py-8 rounded-top-5">
                <div className="container text-center">
                    ...
                    <ul className="list-unstyled d-flex justify-content-center mb-0">
                        ...
                        <li className="me-5">
                            <NavLink to="/about" className="link-white lh-sm footer-link d-block fw-bold"
                            >品牌故事</NavLink>
                        </li>
                        <li>
                            <NavLink
                    ...
                    <ul className="list-unstyled d-flex justify-content-center mb-0">
                        <li className="me-5">
                            <NavLink to="#" className="link-white lh-sm footer-link d-block fw-bold"
                            >隱私權政策</NavLink>
                        </li>
                        <li>
                            <NavLink to="#" className="link-white lh-sm footer-link d-block fw-bold"
