...
const AccountManage = () => {
  ...
  return (
    <>
      {!isAuth ? (
        <div className="container account-wrapper d-flex flex-column align-items-center justify-content-center">
          <h1 className="fs-1 text-primary mb-5">無此頁面訪問權限</h1>
          <button
            type="button"
          ...
          <div className="account-container mx-auto">
            ...
            <div className="border border-4 border-secondary-300 rounded-3 position-relative mb-5">
              <div className="text-center m-5">
                <h2 className="section-title fs-2 text-primary">
                  Order Status
                </h2>
              </div>
              <Link
