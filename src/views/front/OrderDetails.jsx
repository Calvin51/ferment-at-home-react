  ...
  return (
    <section className="container-fluid text-center mt-lg-10 mt-6 mb-lg-11">
      ...
      <div className="container d-none d-lg-block border border-4 border-secondary-300 rounded-3">
        ...
        {detail && (
          <div className="row m-lg-8 gap-lg-5 justify-content-center">
            <div
              className={`col text-center border-top-8 ${detail.status === "訂單成立" ? "border-secondary-300" : "border-gray-100"}`}
            >
              <p className="pt-3 fs-9">訂單成立</p>
            </div>
            <div
              className={`col text-center border-top-8 ${detail.status === "配送中" ? "border-secondary-300" : "border-gray-100"}`}
            >
              <p className="pt-3 fs-9">配送中</p>
            </div>
            <div
              className={`col text-center border-top-8 ${detail.status === "理貨中" ? "border-secondary-300" : "border-gray-100"}`}
            >
              <p className="pt-3 fs-9">理貨中</p>
            </div>
            <div
              className={`col text-center border-top-8 ${detail.status === "已到貨" ? "border-secondary-300" : "border-gray-100"}`}
            >
              <p className="pt-3 fs-9">已到貨</p>
            </div>
            <div
              className={`col text-center border-top-8 ${detail.status === "已收貨" ? "border-secondary-300" : "border-gray-100"}`}
            >
        ...
        <div className=" mb-8 mx-8">
          <div className="mb-5">
            <h5 className="section-title fs-lg-5 text-primary text-start">
              Order Details
            </h5>
          </div>
          ...
          {detail && (
            <ul className="list-unstyled">
              <li className="text-gray-950 fs-8 d-flex justify-content-between mb-3">
                <span>商品總金額</span>
                <span>NT$ {detail.amount.productsTotal}</span>
              </li>
              <li className="text-gray-950 fs-8 d-flex justify-content-between mb-3">
                <span>運費</span>
                <span>NT$ {detail.amount.shippingFee}</span>
              </li>
              <li className="text-gray-950 d-flex justify-content-between">
                <span className="fs-8">總付款金額</span>
                <h5 className="fs-5 text-primary section-title">
                  NT$ {detail.amount.grandTotal}
                </h5>
              </li>
            </ul>
          )}
      ...
      <div className="container d-lg-none ">
        ...
        <div className="mb-7">
          <div className="mb-5">
            <h5 className="section-title fs-5 text-primary text-start">
              Order Summary
            </h5>
          </div>
          <ul className="list-unstyled">
            {orderProduct.map((product, index) => {
              return (
                <li
                  className="d-flex align-items-center gap-5 px-3 pt-3 pb-5 border-bottom border-gray-100"
                  key={index}
                >
                  <img
                    src={productImages[product.name]}
        ...
        <div className="mb-7">
          <div className="mb-5">
            <h5 className="section-title fs-5 fs-lg-5 text-primary text-start">
              Customer Information
            </h5>
          </div>
          {detail && (
