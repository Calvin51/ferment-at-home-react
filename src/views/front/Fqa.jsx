...
const FAQ_ICON_URLS = {
    ...
    minus: 'https://raw.githubusercontent.com/Fury51/img-base/0b8aa0769c819eab32b2865fa834b99de9f1ae25/%E5%9C%96%E5%BA%AB/faq-minus.svg',
}
    ...
    payment: [
        {
            ...
            answer: {
                intro: "目前提供以下三種付款方式：",
                items: [
                    { title: "貨到付款", details: ["訂購成功後，待收到包裹時再直接付款。"] },
                    { title: "信用卡付款（VISA、MasterCard、JCB）", details: ["在結帳頁面選擇「信用卡付款」，輸入卡片相關資訊即可完成付款。"] },
                    { title: "銀行轉帳", details: ["訂單確認後，系統會提供一組銀行帳號，請於 3 日內完成匯款，以確保訂單執行。", "若逾期未付款，訂單可能會自動取消。"] },
                ],
            },
        },
        {
            ...
            answer: {
                intro: "訂單取消與延後說明：",
                items: [
                    { title: "取消訂單", details: ["若訂單尚未出貨，可聯繫客服取消訂單。"] },
                    { title: "延後配送", details: ["可在訂單出貨前聯繫客服調整配送日期。"] },
                ],
            },
        },
        {
            ...
            answer: {
                intro: "發票開立方式：",
                items: [
                    { title: "電子發票", details: ["結帳時填寫發票資訊，發票將於出貨後寄送至您的信箱。"] },
                    { title: "統一編號", details: ["需要報帳者，請在結帳時填寫公司統一編號。"] },
                ],
            },
        },
    ],
    shipping: [
        {
            ...
            answer: {
                ...
                items: [
                    ...
                    { title: "超商取貨", details: ["可選擇 7-11、全家、萊爾富超商取貨。"] },
                ],
            },
        },
        {
            ...
            answer: {
                ...
                items: [
                    ...
                    { title: "送達時間", details: ["宅配約 1-2 天，超商取貨約 2-3 天。"] },
                ],
            },
        },
        {
            ...
            answer: {
                intro: "商品問題處理方式：",
                items: [
                    { title: "商品瑕疵", details: ["收到瑕疵商品請於 7 天內聯繫客服，我們將為您更換。"] },
    ...
    products: [
        {
            ...
            answer: {
                intro: "食材保鮮說明：",
                items: [
                    { title: "低溫配送", details: ["所有食材採用低溫宅配，確保新鮮送達。"] },
                    { title: "保存方式", details: ["收到後請立即冷藏或冷凍保存，並於保存期限內使用完畢。"] },
                ],
            },
        },
        {
        ...
        },
        {
            ...
            answer: {
                ...
                items: [
                    ...
                    { title: "起司", details: ["依種類不同，請參照包裝標示冷藏或冷凍保存。"] },
                ],
            },
        },
    ],
            ...
            <section>
                <div className="container">
                    ...
                    <div className="row pb-100">
                        {[
                            { img: question, q: '如何購買 Pizza 材料包？', a: '進入官網首頁後，先選擇你想要的類別（如餅皮、醬料），加入購物車後依步驟結帳即可。' },
                            { img: questionTwo, q: '可以製作專屬於我的 Pizza 嗎？', a: '當然可以！我們提供客製化 Pizza 材料包服務，可依照喜好自由搭配餅皮、醬料與配料。' },
                            { img: questionThree, q: 'Pizza 材料應該如何保存？', a: '餅皮冷凍保存、醬料與配料冷藏保存，起司依種類需冷凍或冷藏，並於建議期限內使用完畢。' },
                        ].map(({ img, q, a }, i) => (
                            <div key={i} className={`col-lg-4 ${i < 2 ? 'mb-5' : ''}`}>
                                <div className="text-center pb-3">
                                    <img className="img-fluid" src={img} alt="img" />
                                </div>
                                <p className="text-center px-5 py-14 fs-8 bg-white rounded-2 mb-3 text-gray-950">{q}</p>
                                <p className="bg-secondary rounded-2 fs-8 px-5 pt-5 pb-51 lh-base text-gray-950">{a}</p>
                            </div>
                        ))}
                    </div>
                </div>
