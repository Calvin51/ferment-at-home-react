              ...
              <div className="d-lg-block form-checked rounded-3 mt-lg-11">
                <div className="text-start">
                  <form onSubmit={handleSubmit(onSubmit)} className="px-md-4">
                    <div className="row">
                      <h3 className="text-font text-primary mb-lg-5 mt-md-8">
                        Payment Method
                      </h3>
                      ...
                      <h3 className="text-font text-primary mb-md-5 mt-md-8">
                        Shipping Method
                      </h3>
                      ...
                      <div className="col-md-6 mb-3">
                        <label
                          className={`form-label ${!selectedShipping ? "text-muted" : ""}`}
                        >
                          配送時段
                        </label>
                        <select
                      ...
                      {/* 超商取貨門市 */}
                      {(selectedShipping === "7-11 超商取貨" ||
                        selectedShipping === "全家超商取貨") && (
                      ...
                      <div className="col-md-6 mb-3">
                        ...
                        <input
                          ...
                          {...register("phone", {
                            ...
                            pattern: {
                              value: /^09\d{8}$/,
                              message: "電話格式不正確（需為 09 開頭共 10 碼）",
                            },
                          })}
                        />
                        {errors.phone && (
